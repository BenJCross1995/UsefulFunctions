---
title: "R Notebook"
subtitle: "`r wordcountaddin::word_count('~/R Trial/Trial.Rmd')`"
output:
  pdf_document: default
  pdf: default
params:
  save_version: "Save Version of Report? Y or N?"
...
When you save the notebook, an HTML file containing the code and output will be saved alongside it (click the *Preview* button or press *Ctrl+Shift+K* to preview the HTML file). a tiny princess is the best princess for James Cross.
...
report_details(report_location = '~/R Trial/Trial.Rmd',
               details_location = '~/R Trial/Project Details.csv',
               save_location = '~/R Trial/Archive/')
